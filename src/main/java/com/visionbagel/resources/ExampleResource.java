...
import com.visionbagel.payload.SingleInputStreamBody;
...
public class ExampleResource {
    ...
    @Transactional
    @Produces("image/png")
    public InputStream hello(@BeanParam Example params, @BeanParam PageParams pageParams) throws AlipayApiException, IOException {
